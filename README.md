#  LIS Linkage Group Plot

LIS Linkage Group Plot is a tool made for [BlueGenes](http://bluegenes.apps.intermine.org) following BlueGenes Tool API.

It displays a linkage group with markers and QTLs on a linkage group report page.
...
1. Clone the repo
2. `cd lis-linkagegroup-plot` and then `npm install` to install dependencies.
